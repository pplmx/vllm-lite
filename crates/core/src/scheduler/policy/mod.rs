...
//!
//! Built-in impls: [`fcfs`] (first-come-first-served), [`priority`] (priority queue), [`sjf`] (shortest-job-first). New policies implement [`SchedulingPolicy`](trait_def::SchedulingPolicy).
