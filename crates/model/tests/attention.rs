...
fn test_gqa_expand_kv_same_heads() {
    ...
    let attn = GqaAttention::new(256, 4, 4, 64, None, AttentionConfig::default()).unwrap();
...
fn test_gqa_expand_kv_gqa() {
    ...
    let attn = GqaAttention::new(512, 8, 2, 64, None, AttentionConfig::default()).unwrap();
...
fn test_gqa_expand_kv_mqa() {
    ...
    let attn = GqaAttention::new(512, 8, 1, 64, None, AttentionConfig::default()).unwrap();
...
fn test_gqa_attention_forward_single_token() {
    ...
    let attn = GqaAttention::new(896, 14, 2, 64, None, AttentionConfig::default()).unwrap();
...
fn test_attention_output_is_different_from_input() {
    let device = Device::Cpu;
    let attn = GqaAttention::new(256, 4, 2, 64, None, AttentionConfig::default()).unwrap();
