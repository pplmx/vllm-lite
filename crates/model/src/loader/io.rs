//! I/O utilities for checkpoint loading.
//!
...
/// load_file_mmap_or_read: load file mmap or read.
...
/// find_safetensors_files: find safetensors files.
...
mod tests {
    ...
    fn test_load_file_uses_mmap_for_large() {
        ...
        let data = load_file_mmap_or_read(&large_file).unwrap();
    ...
    fn test_load_file_uses_read_for_small() {
        ...
        let data = load_file_mmap_or_read(&small_file).unwrap();
    ...
    fn test_load_file_fallback_on_error() {
        ...
        let data = load_file_mmap_or_read(&file).unwrap();
