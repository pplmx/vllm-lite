...
| [adr/](./adr/)                                                           | Contributors             | 21 Architecture Decision Records                                                       |
...
├── adr/                  # Human: ADR-001 … ADR-021
├── reference/            # Human: stable reference docs (OpenAI compatibility, feature matrix, config keys)
